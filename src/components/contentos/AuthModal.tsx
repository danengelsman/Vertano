        ...
        <div className="earnest-auth-panel rounded-[2rem] border border-white/60 p-8 shadow-[0_32px_80px_rgba(23,20,17,0.18)]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              {mode === 'login' ? 'Sign in to continue building toward profit' : 'Start your journey to your first paycheck'}
            </p>
          </div>

          <div className="space-y-2.5 mb-6">
            <Button variant="outline" className="w-full h-11 gap-3 text-sm font-medium" onClick={handleGoogle}>
            ...
            <Button variant="outline" className="w-full h-11 gap-3 text-sm font-medium" onClick={() => {
              toast({ title: 'Apple Sign In', description: 'Apple sign-in is not available yet.' });
            }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {mode === 'signup' && (
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-11 rounded-xl border-border/80 bg-white/70 pl-10"
                />
              </div>
            )}
            <div className="relative">
            ...
            <Button
              type="submit"
              disabled={submitting}
              className="w-full h-11 gap-2 rounded-full bg-primary text-primary-foreground hover:bg-primary/92"
            >
