...
import { getFirestore, doc, serverTimestamp, getDocFromServer } from 'firebase/firestore';
 ...
 */
export async function compressBase64Image(base64Str, maxWidth = 800, quality = 0.8) {
